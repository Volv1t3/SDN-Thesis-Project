"""Prueba la validacion estricta del archivo de metadata del modelo.
...
from app.model.metadata import load_metadata
...
def test_valid_metadata_loads(tmp_path, metadata_payload):
    ...
    assert metadata.model_name == "sdnflow_xgboost_first_packet"
...
def test_invalid_json_fails(tmp_path):
    """Comprueba que un archivo JSON malformado produzca `ValueError`."""
