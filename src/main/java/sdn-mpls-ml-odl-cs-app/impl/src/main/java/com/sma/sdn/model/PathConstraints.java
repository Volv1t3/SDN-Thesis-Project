...
/**
 * Define el registro {@code PathConstraints} dentro del controlador SDN-MPLS-ML.
 ...
 */
public record PathConstraints(long requestedBandwidthKbps, int setupPriority, int holdPriority) {
}
